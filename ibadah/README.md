# Ibadah — Islamic Center &amp; Mosque Website Template
...
| `admin.html` | **Admin panel** — edit texts, prayer settings, campaigns, courses, events and **media embeds** (demo code: `ibadah01`) |
| `ibadah-offline.html` | Single-file build: all CSS, JS, images and the full Quran text inlined. Opens from disk with no server and no internet |
...
Or simply double-click `ibadah-offline.html` — works offline, no server needed.
...
├── ibadah-offline.html            # single-file offline build
...
├── docs/Ibadah-Template-Guide.pdf # full buyer guide (setup, customization, hosting)
