/* ============================================================
   ...
   free public sources, no API keys, no backend, no maintenance.
   ============================================================ */
...
const US_CITIES = new Set([
  ...
  "walnut creek","princeton","albany","ann arbor","asheville","boise",
  "corvallis","davis","durham","evanston","fort collins","gainesville",
  "hershey","knoxville","lexington","lincoln","little rock","louisville",
  "mclean","memphis","mesa","norfolk","pasadena","provo","reston","round rock",
  "san mateo","scottsdale","sioux falls","spokane","springfield","stamford",
  "syracuse","tallahassee","wichita","wilmington","worcester","birmingham",
  "manchester","bristol","oxford","plymouth","brighton",
]);
const EU_WORDS = [
  "europe","european","uk","united kingdom","britain","british","england",
  "scotland","wales","northern ireland","ireland","france","germany",
  "deutschland","allemagne","spain","españa","italy","italia","portugal",
  "netherlands","nederland","holland","belgium","belgique","belgie",
  "luxembourg","switzerland","schweiz","suisse","austria","österreich",
  "sweden","sverige","norway","norge","denmark","danmark","finland","suomi",
  "iceland","poland","polska","polen","czech","czechia","slovakia","hungary",
  "romania","bulgaria","greece","croatia","slovenia","serbia","bosnia",
  "montenegro","north macedonia","albania","kosovo","estonia","latvia",
  "lithuania","ukraine","moldova","belarus","russia","malta","cyprus",
  "turkey","türkiye","georgien","armenia","arménie","azerbaijan",
  "monaco","andorra","liechtenstein","gibraltar","isle of man",
  "bavaria","bayern",
];
const EU_ABBR = new Set([
  "uk","gb","ie","fr","es","it","pt","nl","be","lu","ch","at","se","no",
  "dk","fi","is","pl","cz","sk","hu","ro","bg","gr","hr","si","rs","ba",
  "mk","xk","ee","lv","lt","ua","by","ru","cy","tr",
]);
const EU_CITIES = new Set([
  "london","leeds","liverpool","edinburgh","glasgow","belfast","cardiff",
  "dublin","cork","paris","lyon","marseille","toulouse","bordeaux","nice",
  "lille","strasbourg","nantes","berlin","munich","munchen","münchen",
  "hamburg","frankfurt","cologne","köln","stuttgart","dusseldorf","düsseldorf",
  "leipzig","dortmund","essen","bremen","dresden","hanover","nuremberg",
  "nürnberg","trier","zurich","zürich","geneva","genève","basel","bern",
  "lausanne","amsterdam","rotterdam","utrecht","eindhoven","brussels",
  "brussel","antwerp","ghent","vienna","wien","graz","linz","salzburg",
  "madrid","barcelona","valencia","seville","bilbao","malaga","lisbon",
  "lisboa","porto","milan","milano","rome","roma","turin","torino","naples",
  "napoli","florence","firenze","warsaw","warszawa","krakow","kraków",
  "wroclaw","gdansk","poznan","lodz","lublin","katowice","szczecin",
  "prague","praha","brno","bratislava","budapest","debrecen","szeged",
  "bucharest","bucuresti","cluj","timisoara","iasi","brasov","sofia",
  "plovdiv","varna","athens","athina","thessaloniki","zagreb","split",
  "dubrovnik","ljubljana","belgrade","beograd","sarajevo","skopje","tirana",
  "podgorica","tallinn","tartu","riga","vilnius","kaunas","klaipeda","kyiv",
  "kiev","lviv","odesa","chisinau","minsk","valletta","nicosia","limassol",
  "istanbul","ankara","tbilisi","yerevan","baku","reykjavik","monaco",
  "gibraltar","stockholm","gothenburg","malmo","uppsala","lund","oslo",
  "bergen","stavanger","trondheim","copenhagen","københavn","helsinki",
  "tampere","turku","oulu",
]);
const UK_AMBIGUOUS_CITIES = [
  "manchester","birmingham","bristol","cambridge","oxford","newcastle",
  "richmond","plymouth","brighton","york","bath",
];
...
const COUNTRY_MARKERS = [
  ["United Kingdom", ["united kingdom","britain","british","england","scotland",
    "wales","northern ireland","uk","london","manchester","birmingham","bristol",
    "cambridge","oxford","newcastle","richmond","plymouth","brighton","york",
    "bath","leeds","liverpool","edinburgh","glasgow","belfast","cardiff",
    "grossbritannien","großbritannien","royaume-uni"]],
  ["Germany", ["germany","deutschland","allemagne","bavaria","bayern","berlin",
    "munich","munchen","münchen","hamburg","frankfurt","cologne","köln",
    "stuttgart","dusseldorf","düsseldorf","leipzig","dortmund","essen","bremen",
    "dresden","hanover","nuremberg","nürnberg","trier","de-"]],
  ["France", ["france","paris","lyon","marseille","toulouse","bordeaux","nice",
    "lille","strasbourg","nantes"]],
  ["Netherlands", ["netherlands","nederland","holland","amsterdam","rotterdam",
    "utrecht","eindhoven"]],
  ["Belgium", ["belgium","belgique","belgie","brussels","brussel","antwerp","ghent"]],
  ["Switzerland", ["switzerland","schweiz","suisse","zurich","zürich","geneva",
    "genève","basel","bern","lausanne","luzern"]],
  ["Austria", ["austria","österreich","oesterreich","vienna","wien","graz","linz",
    "salzburg"]],
  ["Spain", ["spain","españa","espana","espagne","madrid","barcelona","valencia",
    "seville","bilbao","malaga"]],
  ["Portugal", ["portugal","lisbon","lisboa","porto"]],
  ["Italy", ["italy","italia","italie","milan","milano","rome","roma","turin",
    "torino","naples","napoli","florence","firenze"]],
  ["Ireland", ["ireland","irland","irlande","dublin","cork"]],
  ["Sweden", ["sweden","sverige","schweden","suède","stockholm","gothenburg",
    "malmo","uppsala","lund"]],
  ["Norway", ["norway","norge","norwegen","oslo","bergen","stavanger","trondheim"]],
  ["Denmark", ["denmark","danmark","dänemark","copenhagen","københavn","aarhus",
    "odense"]],
  ["Finland", ["finland","finlande","finnland","suomi","helsinki","tampere",
    "turku","oulu"]],
  ["Iceland", ["iceland","island","ísland","reykjavik"]],
  ["Poland", ["poland","polska","polen","pologne","warsaw","warszawa","krakow",
  ...
  ["Romania", ["romania","românia","rumänien","bucharest","bucuresti","cluj",
    "timisoara","iasi","brasov"]],
...
const hasWord = (words, s) => words.some(
  w => new RegExp("\\b"+w.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")+"\\b").test(s));

const US_STRONG = ["united states","usa","u.s.a","us only", ...US_STATES];
const EU_STRONG  = [
  "europe","european","united kingdom","britain","british","england","scotland",
  "wales","northern ireland","ireland","france","germany","deutschland",
  "allemagne","spain","españa","italy","italia","portugal","netherlands",
  "nederland","holland","belgium","belgique","belgie","luxembourg","switzerland",
  "schweiz","suisse","austria","österreich","sweden","sverige","norway","norge",
  "denmark","danmark","finland","suomi","iceland","poland","polska","polen",
  "czech","czechia","czech republic","slovakia","hungary","romania","bulgaria",
  "greece","croatia","slovenia","serbia","bosnia","montenegro","macedonia",
  "albania","kosovo","estonia","latvia","lithuania","ukraine","moldova",
  "belarus","russia","malta","cyprus","turkey","türkiye","georgien","armenia",
  "azerbaijan","monaco","andorra","liechtenstein","gibraltar","isle of man",
  "bavaria","bayern",
];
...
const TAXONOMY = [
  ...
  ["Data & AI",        ["data","analytics","analyst","machine learning"," ml ",
  ...
  ["Marketing & Growth",["marketing","seo","growth","digital marketing","social media",
    "content marketing","brand","affiliate","ppc","advertising","go-to-market",
    "gtm","communications","community","email marketing","cmo"]],
  ["Sales & Business Dev",["sales","account executive","business development","bdr",
    "sdr","account manager","partnership","sales development","closer"]],
  ["Product & Project",["product","pm","product manager","product owner","project manager",
    "program manager","scrum","agile","delivery manager"]],
  ...
  ["Finance & Accounting",["finance","accounting","bookkeeper","financial","tax","audit",
    "payroll","controller","treasury","cpa","actuary","banking"]],
  ["HR & Recruiting",  ["hr","human resources","recruiter","recruiting","talent",
    "people operations","people","onboarding","payroll adm"]],
  ["Writing & Content",["writing","writer","content","copywriter","editor","journalism",
    "translation","editorial","blog","author","proofreader"]],
  ["Operations & Admin",["operations","administration","office manager","logistics",
    "supply chain","facilities","executive assistant","admin","procurement",
    "warehouse","driver","receptionist","clerk"]],
  ["Education & Training",["education","teacher","tutor","training","instructional",
    "elearning","learning","professor","curriculum","edtech"]],
  ["Healthcare & Wellness",["healthcare","nurse","medical","clinical","health","therapy",
    "pharma","physician"," care ","dentist","psycholog","wellness"]],
  ["Legal & Compliance",["legal","lawyer","attorney","compliance","counsel","paralegal",
    "law ","legal counsel","regulatory"]],
];
const OTHER = "Other";
const EXTRA_KEYS = {
  "Engineering & IT":   ["informatik","informatica","informática","informatyka",
    "ingenieur","ingeniero","ingénieur","inżynier","entwickler","desarrollador",
    "programador","programmeur","programista","softwareentwickler","sistemas",
    "système","elektronik","netzwerk","technik","ingeniería","ingenierie"],
  "Data & AI":          ["daten","datos","données","dane",
    "künstliche intelligenz","inteligencia artificial","intelligence artificielle",
    "sztuczna inteligencja","analityk"],
  "Design & Creative":  ["gestaltung","diseño","conception","projektowanie",
    "grafika","ilustración","illustration"],
  "Marketing & Growth": ["werbung","publicidad","pubblicità","reklama",
    "kommunikation","comunicación","communication","communicatie","komunikacja",
    "mercadeo"],
  "Sales & Business Dev":["verkauf","vertrieb","ventas","vendite","sprzedaż",
    "verkoop","handel","commercial"],
  "Product & Project":  ["produktmanager","projektleitung","projektmanager",
    "chef de projet","projectleider","kierownik projektu","productmanager"],
  "Customer Support":   ["kundendienst","service client","servicio al cliente",
    "klantenservice","obsługa klienta"],
  "Finance & Accounting":["finanzen","finanzas","finances","financieel","księgowość",
    "buchhaltung","comptabilité","contabilidad","contabilità","rechnungswesen",
    "buchhalter","accountant","finanz"],
  "HR & Recruiting":    ["personalwesen","recursos humanos","ressources humaines",
    "personeelszaken","zasoby ludzkie"],
  "Writing & Content":  ["redaktion","redacción","rédaction","übersetzer","traductor",
    "traducteur","tłumacz"],
  "Operations & Admin": ["logistik","logística","logistique","logistiek","logistyka",
    "verwaltung","administración","administration","administratie","administracja",
    "einkauf","compras","achats","inkoop","zakupy","lager","sachbearbeiter"],
  "Education & Training":["bildung","enseñanza","enseignement","onderwijs","nauczanie",
    "lehrer","profesor","enseignant","docent","nauczyciel","ausbildung"],
  "Healthcare & Wellness":["gesundheit","gesundheitswesen","pflege","soins","santé",
    "sanidad","salud","salute","zdrowie","gezondheidszorg","verpleging",
    "verpleegkundige","cuidados","medizin","médecine","medicina","medycyna",
    "krankenpflege","infirmier"],
  "Legal & Compliance": ["recht","droit","derecho","diritto","prawo","juridique",
    "juridisch","jurídico","giuridico","prawny","anwalt","advocaat"],
};
...
const SOURCES = [
  {
    ...
    parse(json) {
      ...
      for (const r of json.results || []) {
        ...
        out.push({
          id:`muse-${r.id}`, title:r.name || "", company:(r.company||{}).name || "",
          logo:"", location:locs.join("; ") || "United States", remote:false, type:"",
          salary:"", date:r.publication_date || "", category:mapCategory(...cats,...tags,r.name),
          tags:tags.slice(0,6), description:r.contents || "",
          url:(r.refs||{}).landing_page || "", source:"The Muse",
        });
      }
      return out;
    },
  },
  {
    ...
    parse(json) {
      ...
      for (const r of json.jobs || []) {
        ...
        const jt = r.jobType || [], ind = r.jobIndustry || [];
        out.push({
          id:`jobicy-${r.id}`, title:r.jobTitle || "", company:r.companyName || "",
          logo:r.companyLogo || "", location:r.jobGeo || "", remote:true,
          type:jt[0] || "Remote",
          salary:[r.salaryMin,r.salaryMax].some(x => x) ? fmtMoney(r.salaryMin,r.salaryMax) : "",
          date:r.pubDate || "", category:mapCategory(...ind,r.jobTitle),
          tags:ind.slice(0,4), description:r.jobDescription || r.jobExcerpt || "",
          url:r.url || "", source:"Jobicy",
        });
      }
      return out;
    },
  },
  {
    ...
    parse(json) {
      ...
      for (const r of json || []) {
        ...
        out.push({
          id:`remoteok-${r.slug||r.id}`, title:r.position || "", company:r.company || "",
          logo:r.company_logo || r.logo || "", location:loc, remote:true, type:"Remote",
          salary:fmtMoney(r.salary_min,r.salary_max), date:r.date || "",
          category:mapCategory(...(r.tags||[]),r.position),
          tags:(r.tags||[]).slice(0,6), description:r.description || "",
          url:r.apply_url || r.url || "", source:"RemoteOK",
        });
      }
      return out;
    },
  },
  {
    ...
    parse(json) {
      ...
      for (const r of json.jobs || []) {
        ...
        out.push({
          id:`remotive-${r.id}`, title:r.title || "", company:r.company_name || "",
          logo:r.company_logo_url || r.company_logo || "",
          location:r.candidate_required_location || "", remote:true,
          type:(r.job_type||"").replace(/_/g," "), salary:r.salary || "",
          date:r.publication_date || "", region:regionOf(r.candidate_required_location||"") || "",
          category:mapCategory(r.category,...(r.tags||[]),r.title),
          tags:(r.tags||[]).slice(0,6), description:r.description || "",
          url:r.url || "", source:"Remotive",
        });
      }
      return out;
    },
    ...
    parse(json) {
      ...
      for (const r of json.data || []) {
        ...
        out.push({
          ...
          title:r.title || "", company:r.company_name || "", logo:"",
          location:loc, region:reg, country:isUkSource?"United Kingdom":countryOf(loc),
          remote:!!r.remote, type:jt[0] || "", salary:"",
          date:r.created_at ? new Date(r.created_at*1000).toISOString() : "",
          category:mapCategory(...(r.tags||[]),r.title),
          tags:(r.tags||[]).slice(0,6), description:r.description || "",
          url:r.url || "", source:"Arbeitnow",
        });
      }
      return out;
    },
...
function mergeJobs(list) {
  ...
  for (const raw of list) {
    ...
    byId.set(j.id, dup && (j.description||"").length > (dup.description||"").length
      ? j : dup || j);
  }
...
async function refreshLive(initial = false) {
  ...
  if (!initial && gained > 0) {
    toast(`${gained} new job${gained > 1 ? "s" : ""} found automatically`,
      "Show", showToastRefresh);
  }
  updateSyncPills();
}
...
function matches(j, f) {
  ...
  if (f.q) {
    const hay = `${j.title} ${j.company} ${j.location} ${j.category} ${
...
function sourceAttribution(job) {
  ...
  if (job.source === "Adzuna") {
    return `<a class="source-credit adzuna-credit" href="${url}" target="_blank" rel="${rel}"
      aria-label="Jobs by Adzuna"><span>Jobs by</span>
      <img src="assets/adzuna-logo.png" alt="Adzuna" width="63" height="23"></a>`;
  }
  return `<a class="source-credit" href="${url}" target="_blank" rel="${rel}">
    Source: ${esc(sourceName(job.source))}</a>`;
}
...
<article class="job-card" data-id="${esc(job.id)}">
  <div class="job-card-top">
    ...
    <div style="min-width:0">
      <h3 class="job-title"><a href="${job.detail_path ? esc(job.detail_path) : `#/job/${encodeURIComponent(job.id)}`}">${esc(job.title)}</a></h3>
      <div class="job-company">${esc(job.company)}</div>
    </div>
    <button class="bookmark-btn ${saved ? "saved" : ""}" data-bookmark="${esc(job.id)}"
      aria-label="Save job" title="Save job">${saved ? "★" : "☆"}</button>
  </div>
  <div class="job-meta">
  ...
  ${job.tags && job.tags.length
    ? `<div class="job-tags">${job.tags.slice(0,3).map(t =>
        `<span class="job-tag">${esc(t)}</span>`).join("")}</div>` : ""}
  <div class="job-foot">
    <span class="job-source-line">
      <span class="posted-age">${timeAgo(job.date)}</span>
      ${sourceAttribution(job)}
    </span>
    <a class="apply" href="${esc(job.url)}" target="_blank" rel="noopener noreferrer">
      Apply <span>→</span></a>
  </div>
</article>`;
}
...
function schNormalize(s) {
  // Generate ID from title if not present (for data/scholarships.json which lacks id field)
  if (!s.id) {
    s.id = encodeURIComponent(String(s.title || "").toLowerCase()
      .replace(/[^a-z0-9]+/g, "-")
      .replace(/^-|-$/g, "")
      .slice(0, 100)) || "schol-" + Math.random().toString(36).slice(2, 10);
  }
...
function schMatches(s, f) {
  ...
  if (f.region  !== "All") {
    if (f.region === "AR") {
      ...
      if (s.region !== "AR" && !["Egypt","Morocco","Tunisia","Algeria",
        ...
        "Mauritania","Djibouti","Yemen","Somalia","Comoros","Somaliland"]
        .some(c => (s.country || "").toLowerCase() === c.toLowerCase()))
        return false;
  ...
  if (f.country !== "All") {
    if (f.country === "WW") { if (s.country) return false; }
      ...
      if (!["egypt","morocco","tunisia","algeria","jordan","lebanon",
        ...
        .some(c => (s.country || "").toLowerCase().includes(c)))
        return false;
    }
...
function schVisible() {
  const f = SCH_FILTERS;
  let arr = state.scholarships.filter(s => schMatches(s, f));
  if (f.sort === "amount")   arr = [...arr].sort((a,b) => b.amountNum - a.amountNum);
...
function scholarshipCardHtml(s) {
  ...
  const fc = fundingColors[s.funding] || fundingColors["Annual"];
...
function loadTabPref() {
  try {
    const saved = localStorage.getItem("ww:tab");
    if (saved === "scholarships" || saved === "jobs") return saved;
  } catch {}
  return "jobs";
}
...
function injectFeedAds() {
  ...
  const top = $("#adTop");
  if (top) { top.innerHTML = ""; top.append(adEl(CONFIG.adSlots.top)); }
}

/* ============================ INTERACTIONS ============================ */
function applyFilters() { renderHome(); }
...
function bindEvents() {
  ...
  // ── CONSENT ──
  window.addEventListener("wintworks:consentchange", e => {
  ...
  if (CONFIG.browserLiveRefresh) {
    ...
    document.addEventListener("visibilitychange", () => {
      if (!document.hidden && state.lastLive &&
          Date.now() - state.lastLive > CONFIG.refreshMinutes * 60000)
        refreshLive();
    });
  }
...
async function fetchScholarshipApiLive() {
  ...
  if (!token) return [];
  try {
    const res = await fetch("https://api.scholarshipapi.com/v1/search", {
      method:"POST",
      headers:{
    ...
    return (data.hits || []).map(h => ({
      ...
      region: "",
      country:"",
      remote: h.status === "open",
      funding:h.primaryCategory || "Annual",
      amount: h.amount ? Number(h.amount) : null,
      amount_str: h.amount ? `${h.amount} ${h.currency || ""}` : "",
      deadline: h.closeDate ? new Date(Number(h.closeDate)).toISOString() : "",
      level: "",
      description: h.eligibilitySummary || "",
      tags: (h.targetGroups||[]).filter(t => typeof t === "string").slice(0,4),
      url:   h.url || "",
